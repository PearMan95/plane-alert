...
- **Alert sound** — choose from Ping, Radar, Alert or Chime with adjustable volume
...
- **Settings** — configure location, radius (25 / 50 / 100 km or custom), notification timeout and content
